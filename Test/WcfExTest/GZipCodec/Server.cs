//===========================================================================
// MODULE:  Server.cs
// PURPOSE: test WCF server for the gzip message encoder
// 
// Copyright © 2012
...
namespace WcfEx.Test.GZip
{
   /// <summary>
   /// GZip encoder server contract
   /// </summary>
   /// <remarks>
   /// This interface is implemented by the test server and
   /// used as the contract for testing the GZip WCF message
   /// encoder.
   /// </remarks>
   [ServiceContract(Namespace = "http://brentspell.us/Projects/WcfEx/Test/GZip")]
   ...
   /// <summary>
   /// GZip encoder test server
   /// </summary>
   /// <remarks>
   /// This class implements the test contract interface
   /// over the GZip message encoder.
   /// </remarks>
