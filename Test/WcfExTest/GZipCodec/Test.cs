//===========================================================================
// MODULE:  Test.cs
// PURPOSE: GZip WCF encoder unit test driver
// 
// Copyright © 2012
...
namespace WcfEx.Test.GZip
{
   ...
   public class Test
   {
      ...
      private const String TestBufferedUri = "net.pipe://localhost/WcfExTest.GZip.Server/Buffered/";
      private const String TestStreamedUri = "net.pipe://localhost/WcfExTest.GZip.Server/Streamed/";
