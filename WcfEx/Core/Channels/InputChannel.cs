...
// PURPOSE: input channel base class
// 
// Copyright © 2012
...
namespace WcfEx
{
   ...
   /// tedious channel methods for input channels. it encapsulates
   /// the input-only communication channel.
   ...
   /// </remarks>
   public abstract class InputChannel : Channel, IInputChannel
   {
