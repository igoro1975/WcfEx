...
// PURPOSE: GZip codec WCF binding configuration element
// 
// Copyright © 2012
...
{
   /// <summary>
   /// GZip codec binding configuration
   /// </summary>
   /// <remarks>
   /// This class represents the WCF binding element used
   /// to create instances of the GZip encoder factory, and
   /// in turn, the GZip encoder. Use this class directly with
   ...
   ///            <add name="gzipEncoding" type="WcfEx.GZip.BindingElement+Config,WcfEx"/>
   ///         </bindingElementExtensions>
   ///      </extensions>
   ///      <bindings>
   ///         <customBinding>
   ...
   public sealed class BindingElement : MessageEncodingBindingElement, IPolicyExportExtension
   {
      ...
      public void ExportPolicy(MetadataExporter exporter, PolicyConversionContext context)
      {
         context.GetBindingAssertions().Add(
            new XmlDocument().CreateElement("gzip", "GZipEncoding", "http://www.gzip.org/")
         );
      }
      #endregion
